...
<div class="px-2 di-slider-wrapper py-10 lg:px-8 relative container mx-auto <?= implode(' ', $classes) ?>">
    <div class="slider-container flex justify-between pb-12 link-boxes">
        <div class="text-2xl text-black font-extralight justify-start">Relaterade Nyheter</div>
